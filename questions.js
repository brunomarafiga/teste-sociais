...
const questions = [
    ...
    },
    {
        ...
        resposta: "A" // Nota: A afirmação ( ) para Festinger e Carlsmith é sobre obediência induzida ($1 vs $20), justificação do esforço é outro paradigma (Aronson & Mills), mas a lógica do VF aqui parece tratar todas as afirmações como corretas sobre dissonância em geral. A letra V para a última afirmação sobre consonância/importância está INCORRETA segundo a teoria original, mas a opção A marca VVVVV. *Mantendo a resposta do MD, mas com ressalva.*
    },
    {
    ...
    },
    {
        ...
        opcoes: [
            "I, II e III",
            "I, II e V", // A afirmação III (Equidade) também é central, mas a IV é claramente falsa. A opção B inclui I, II, V.
            "I, III e IV",
            "II, IV e V",
            "III, IV e V"
        ],
        resposta: "B" // *Ajuste*: Embora III seja correta, a opção B (I, II, V) é a mais plausível dadas as outras opções e a falsidade clara de IV. A resposta original pode ter considerado III como incorreta ou menos relevante que V.
    },
    {
    ...
    },
    {
        ...
        opcoes: [
            "I e IV",
            "II e III",
            "I, II e III", // O espaço percebido é o da prática espacial; o vivido é o das representações; o concebido é o dos planejadores. A ordem no MD estava I, II, III, mas o conteúdo corresponde a I, III, II na ordem do MD. A opção C (I, II, III são corretas) assume que a descrição de II e III no MD estava invertida.
            "I, III e IV",
            "II, III e IV"
        ],
        resposta: "C" // Assumindo que a intenção era que I, II e III fossem corretas sobre as *definições*, mesmo que a ordem de II e III estivesse trocada no texto da questão.
    },
    {
...
const questions = [
    ...
    },
    {
        ...
        afirmacoes: [
            ...
            "Para Thomas Csordas, a corporeidade (embodiment) representa um paradigma antropológico que considera o corpo não apenas como objeto de representações culturais, mas como sujeito da cultura e base existencial da mesma.",
            "A antropologia contemporânea do corpo tem estabelecido consenso sobre a universalidade das experiências corporais básicas, demonstrando que sensações físicas são interpretadas de maneira idêntica através de diferentes contextos culturais.",
            "David Le Breton argumenta que as modificações tecnológicas do corpo necessarily alienam os indivíduos de suas experiências corporais autênticas, resultando em formas patológicas de subjetividade desconectadas da materialidade corporal."
        ],
        opcoes: [
            "I, II e III",
            "I, III e V",
    ...
    },
    {
        ...
        disciplina: "Antropologia",
        tipo: "MC", // Múltipla Escolha (Incorreta)
        contexto: "Em 2022, antropólogos analisaram como as formaturas universitárias brasileiras, especially na modalidade remota durante a pandemia, mantiveram elementos rituais tradicionais (juramentos, discursos, vestes específicas) mesmo adaptados ao ambiente digital, evidenciando sua importância simbólica para marcar a transição social dos graduandos.",
        pergunta: "Considerando as teorias antropológicas sobre rituais e ritos de passagem, assinale a alternativa INCORRETA:",
        opcoes: [
            "Segundo Arnold Van Gennep, os ritos de passagem estruturam-se tipicamente em três fases: separação (afastamento do estado anterior), liminaridade (período ambíguo entre estados) e reagregação (incorporação ao novo estado), podendo ser identificadas mesmo em versões contemporâneas e adaptadas destes rituais.",
            "Victor Turner ampliou a análise da fase liminar, destacando como a communitas (experiência de igualdade e comunhão entre participantes) suspende temporariamente hierarquias sociais, permitindo reflexão sobre valores e estruturas da sociedade.",
    ...
    },
    {
        ...
        afirmacoes: [
            "Instituições, na definição de Douglass North, são \"regras do jogo\" que estruturam incentivos nas interações humanas, podendo ser formais (leis, constituições) ou informais (costumes, tradições).",
            "A teoria da \"dependência da trajetória\" (path dependence) sugere que escolhas institucionais passadas constrangem possibilities futuras, explicando por que instituições ineficientes podem persistir ao longo do tempo.",
            "A Nova Economia Institucional, representada por autores como Oliver Williamson, analisa como arranjos institucionais surgem para minimizar custos de transação em situações de informação imperfeita e racionalidade limitada.",
            "Para economistas institucionalistas, mercados são instituições históricas e socialmente construídas, não entidades naturais que operariam independentemente de contextos institucionais específicos.",
            "A economia institucional rejeita completamente análises quantitativas e formalizações matemáticas, defendendo abordagens exclusivamente qualitativas e narrativas históricas."
        ],
